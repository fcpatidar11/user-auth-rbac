...
async function entityAdminPermissions() {
    try {
        console.log("=== Database Admin Entity Permission Groups Initialization Started ===");
        ...
        await appDatabase.EntityPermissionGroup.findOneAndUpdate({
            ...
            isActive: true,
            description: DEFAULT_ROLES.ADMIN
        }, { upsert: true });
        console.log("All Admin Entity Permission Groups created/sync with their permissions");
    } catch (error) {
        console.error("Error during database Admin Entity Permission Groups setup:", error);
    } finally {
        process.exit(0);
    }
}
...
if (require.main === module) {
    entityAdminPermissions();
}

module.exports = entityAdminPermissions;